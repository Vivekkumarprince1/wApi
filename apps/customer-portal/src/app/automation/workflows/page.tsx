            ...
            filteredWorkflows.map((wf: AutomationRule, i: number) => (
              ...
              >
                 ...
                 <div className="flex items-center gap-2">
                    ...
                    <Link href={`/automation/workflows/builder/${wf._id}`}>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuItem onClick={() => router.push(`/automation/workflows/${wf._id}/view`)} className="rounded-xl h-10 px-4 font-bold text-xs gap-3">
