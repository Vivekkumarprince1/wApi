...
const ConversationSchema = new mongoose.Schema({
  ...
  // ====== WHATSAPP 24H SESSION MANAGEMENT ======
  // 24-hour conversation window (WhatsApp Business API requirement)
  isOpen: { type: Boolean, default: true },
  windowExpiresAt: { type: Date }, // When the 24h window expires
  lastInboundAt: { type: Date }, // Last time customer sent message
  lastOutboundAt: { type: Date }, // Last time business sent message
