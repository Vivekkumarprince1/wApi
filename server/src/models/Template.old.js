...
const TemplateSchema = new mongoose.Schema({
  ...
  // ═══════════════════════════════════════════════════════════════════
  // BSP MULTI-TENANT FIELDS
  // ═══════════════════════════════════════════════════════════════════
  
  /**
   * The namespaced template name on Meta (BSP model)
   * Format: {workspaceIdSuffix}_{templateName}
   * Used for webhook routing and deletion
   */
  metaTemplateName: { type: String },
  
  /**
   * How this template was submitted to Meta
   */
  submittedVia: { 
    type: String, 
    enum: ['BSP', 'DIRECT', 'MANUAL'], 
    default: null 
  },
