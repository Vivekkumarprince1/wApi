...
const { requirePhoneActivation } = require('../../middlewares/infrastructure/phoneActivation');
const { 
  validateTemplateCreate, 
  validateTemplateUpdate 
} = require('../../middlewares/infrastructure/templateValidation');
const {
  getApprovedTemplatesForWorkspace,
  getTemplateStatusCounts
} = require('../../middlewares/infrastructure/templateGuard');
const {
  createTemplate,
  listTemplates,
  getTemplate,
