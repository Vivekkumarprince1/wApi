...
export type BillingEventName = 'CampaignCreatedEvent' | 'BudgetReservedEvent' | 'BudgetReservationFailedEvent' | 'CampaignCompletedEvent' | 'MessageStatusUpdateEvent';
...
export type BillingPubSubEventName = 'wallet_recharged' | 'plan_purchased' | 'order_paid';
