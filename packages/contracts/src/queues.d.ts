...
export declare const QUEUE_NAMES: {
    ...
    readonly BULK_MESSAGES: "bulk-messages";
    /** Campaign engine — start/batch/check/cleanup (campaign-service + monolith). */
    readonly CAMPAIGN_ENGINE: "campaign-engine";
    ...
    readonly INTEGRATION_SYNC: "integration-sync";
    /** Answerbot site crawl (automation-service). */
    readonly ANSWERBOT_CRAWL: "answerbot-crawl";
    /**
     ...
     */
    readonly WABA_PROVISION: "waba-provision";
};
export type QueueName = (typeof QUEUE_NAMES)[keyof typeof QUEUE_NAMES];
/** Job type discriminators used within the campaign-engine queue. */
export declare const CAMPAIGN_JOB_TYPES: {
    readonly CAMPAIGN_START: "campaign-start";
    readonly BATCH_PROCESS: "batch-process";
    readonly CAMPAIGN_CHECK: "campaign-check";
    readonly SCHEDULED_START: "scheduled-start";
    readonly CLEANUP: "cleanup";
};
export type CampaignJobType = (typeof CAMPAIGN_JOB_TYPES)[keyof typeof CAMPAIGN_JOB_TYPES];
/**
 ...
 */
export declare const WABA_PROVISION_STEPS: {
    readonly NOT_STARTED: "NOT_STARTED";
    readonly PROVISIONING_STARTED: "PROVISIONING_STARTED";
    readonly APP_ASSIGNED: "APP_ASSIGNED";
    readonly TOKEN_RESOLVED: "TOKEN_RESOLVED";
    readonly CONTACTS_SET: "CONTACTS_SET";
    readonly WEBHOOKS_CONFIGURED: "WEBHOOKS_CONFIGURED";
    readonly COMPLETED: "COMPLETED";
    readonly FAILED: "FAILED";
};
export type WabaProvisionStep = (typeof WABA_PROVISION_STEPS)[keyof typeof WABA_PROVISION_STEPS];
/**
...
export type JobPayload<Q extends QueueName> = Q extends keyof QueuePayloads ? QueuePayloads[Q] : unknown;
