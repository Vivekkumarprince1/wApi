 ...
 */
export type WorkspaceSocketEvent = 'workspace:wallet_update' | 'workspace:notification' | 'campaign:status_update' | 'campaign:batch_completed' | 'campaign:message_status_batch' | 'campaign:message_status_update' | 'inbox:message_new' | 'inbox:message_sent' | 'inbox:message_status' | 'inbox:status_batch' | 'inbox:conversation_updated' | 'inbox:reopened' | 'inbox:typing' | 'agent:online' | 'agent:offline' | 'microservice_event';
export type ConversationSocketEvent = 'conversation:typing' | 'conversation:user-joined' | 'conversation:user-left';
