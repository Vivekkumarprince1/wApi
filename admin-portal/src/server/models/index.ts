...
// Fallback schemas for missing models in admin-portal
export const Subscription = mongoose.models.Subscription || mongoose.model('Subscription', new Schema({}, { strict: false }));
export const Wallet = mongoose.models.Wallet || mongoose.model('Wallet', new Schema({}, { strict: false }));
export const WalletTransaction = mongoose.models.WalletTransaction || mongoose.model('WalletTransaction', new Schema({}, { strict: false }));
export const Integration = mongoose.models.Integration || mongoose.model('Integration', new Schema({}, { strict: false }));
