...
export class SuperAdminControlPlaneService {
  static async buildSnapshot(): Promise<SuperAdminControlPlaneSnapshot> {
    ...
    const activeRevenue = billingStats.grossRevenue;
    const totalRechargeTransactions = 0; // Microservice doesn't provide this count yet, setting to 0 for now to avoid crash
