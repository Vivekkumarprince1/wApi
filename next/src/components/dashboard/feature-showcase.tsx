...
const FeatureShowcase = () => {
  ...
  const features: Feature[] = [
    ...
    { title: 'Automation', desc: 'Auto-reply & workflows', icon: Bell, color: 'from-blue-500 to-blue-600', href: '/dashboard/automation' },
    { title: 'Commerce', desc: 'Catalog & checkout', icon: Globe, color: 'from-violet-500 to-violet-600', href: '/dashboard/commerce' },
    { title: 'Integrations', desc: 'Connect your tools', icon: TrendingUp, color: 'from-amber-500 to-amber-600', href: '/dashboard/integrations' },
  ];
