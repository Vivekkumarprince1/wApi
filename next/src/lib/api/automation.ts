...
export const fetchWhatsAppForms = async (params?: { status?: string; search?: string }) => {
  const response = await api.get('/whatsapp-forms', { params });
  return response;
};

export const getWhatsAppForm = async (id: string) => {
  const response = await api.get(`/whatsapp-forms/${id}`);
  return response;
};

export const createWhatsAppForm = async (data: any) => {
  const response = await api.post('/whatsapp-forms', data);
  return response;
};

export const updateWhatsAppForm = async (id: string, data: any) => {
  const response = await api.put(`/whatsapp-forms/${id}`, data);
  return response;
};

export const deleteWhatsAppForm = async (id: string) => {
  const response = await api.delete(`/whatsapp-forms/${id}`);
  return response;
};

export const publishWhatsAppForm = async (id: string) => {
  const response = await api.post(`/whatsapp-forms/${id}/publish`);
  return response;
};

export const unpublishWhatsAppForm = async (id: string) => {
  const response = await api.post(`/whatsapp-forms/${id}/unpublish`);
  return response;
};

export const syncWhatsAppForm = async (id: string) => {
  const response = await api.post(`/whatsapp-forms/${id}/sync`);
  return response;
};

export const fetchWhatsAppFormResponses = async (id: string, params?: { status?: string }) => {
  const response = await api.get(`/whatsapp-forms/${id}/responses`, { params });
  return response;
};
