...
export const config = {
  ...
  baseUrl: process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:5001',
  ...
  whatsappWebhookSecret: process.env.WHATSAPP_WEBHOOK_SECRET || process.env.GUPSHUP_WEBHOOK_SECRET || '',
  whatsappWebhookVerifyToken: process.env.WHATSAPP_WEBHOOK_VERIFY_TOKEN || '',

  // OTP / communication
  otpPepper: process.env.OTP_PEPPER || process.env.JWT_SECRET || 'change-me-in-production',
  ...
  appName: process.env.APP_NAME || 'wApi',
};
