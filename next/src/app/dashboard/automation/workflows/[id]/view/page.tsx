  ...
  if (!rule) {
    return (
      <div className="p-8">
        ...
        <Link href="/dashboard/automation/workflows" className="inline-block mt-4">
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between gap-4">
        <div className="space-y-1">
          <Link href="/dashboard/automation/workflows" className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/dashboard/automation/workflows/builder/${rule._id}`}>
            <Button>
