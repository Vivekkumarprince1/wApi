      ...
      <PageHeader
        ...
        extra={
          <button 
            ...
            className="flex items-center space-x-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-foreground px-4 py-2.5 rounded-xl transition-all duration-200 border border-border"
          >
