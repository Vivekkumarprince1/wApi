...
const CreateContactPanel = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Panel */}
      <div className="ml-auto relative w-full max-w-md bg-card shadow-2xl overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-card border-b border-border p-4 flex items-center justify-between z-10">
          <h2 className="text-lg font-semibold text-foreground">Create Contacts</h2>
          <button
            onClick={onClose}
            ...
            <div className="flex space-x-4">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-teal-600 focus:ring-ring"
                />
              ...
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-teal-600 focus:ring-ring"
                />
                <span className="ml-2 text-sm text-foreground">Automated</span>
              </label>
            </div>
          </div>
          ...
          {method === 'automated' ? (
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent bg-white dark:bg-muted text-foreground text-sm"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3 max-h-[600px] overflow-y-auto">
                {/* Shopify */}
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">Shopify</h3>
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">Mobile App</h3>
                        <p className="text-xs text-muted-foreground">
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">WooCommerce</h3>
                        <p className="text-xs text-muted-foreground">
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">Google Sheets</h3>
                        <p className="text-xs text-muted-foreground">
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">FB Leads Integration</h3>
                        <p className="text-xs text-muted-foreground">
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">Pabbly</h3>
                        <p className="text-xs text-muted-foreground">
                          Leads filling up your FB Lead Forms can be auto-added to your {process.env.NEXT_PUBLIC_APP_NAME || 'Interakt'} account, by using our FB Leads integration.
                        </p>
                      </div>
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">Instamojo</h3>
                        <p className="text-xs text-muted-foreground">
                ...
                <div className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-foreground mb-1">Zapier</h3>
                        <p className="text-xs text-muted-foreground">
            ...
            <div className="mb-6">
              ...
              <div className="border-2 border-dashed border-border rounded-lg p-8 text-center mb-4">
                ...
                <label
                  htmlFor="csv-upload"
                  className="inline-block mt-4 px-4 py-2 bg-muted text-foreground rounded cursor-pointer hover:bg-border dark:hover:bg-gray-600 transition-colors text-sm"
                >
                  Choose File
                </label>
              </div>
              ...
              {/* Instructions */}
              <button className="w-full text-left px-4 py-2 bg-background rounded text-sm text-teal-600 hover:bg-accent transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent bg-white dark:bg-muted text-foreground"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="flex">
                  <select className="px-3 py-2 border border-r-0 border-border rounded-l-lg bg-white dark:bg-muted text-foreground">
                    <option>+91</option>
                    <option>+1</option>
                    <option>+44</option>
                  </select>
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="Enter input here"
                    className="flex-1 px-3 py-2 border border-border rounded-r-lg focus:ring-2 focus:ring-ring focus:border-transparent bg-white dark:bg-muted text-foreground"
                    required
                  />
                </div>
              </div>
