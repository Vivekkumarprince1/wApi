...
export default function IndustrySolutions({ isDark }) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full flex flex-col items-center">
        <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-center px-4" style={{ color: isDark ? '#fff' : '#23291f', fontFamily: 'Inter, system-ui, -apple-system, sans-serif', letterSpacing: '-0.02em' }}>
          Built for any <span style={{ color: '#3ed17b' }}>Industry</span>
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl text-center max-w-2xl px-4 mb-8 sm:mb-12" style={{ color: isDark ? '#ccc' : '#23291f', fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
