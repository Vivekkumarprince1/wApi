...
- `APP_URL`: Server-side public URL used for redirects, emails, and callbacks when available.
- `ALLOWED_ORIGINS`: Comma-separated list of allowed browser origins for CORS and dev origin checks.
