...
export default function WhatsAppFormsPage() {
  ...
  const forms: WhatsAppForm[] = data?.data || [];
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Link href="/dashboard/automation/whatsapp-forms/create">
                ...
                <tr key={form._id} className="border-b last:border-b-0 border-border/30">
                  ...
                  <td className="p-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Link href={`/dashboard/automation/whatsapp-forms/${form._id}/responses`}>
                        <Button variant="ghost" size="icon" title="View responses">
                          <Eye className="h-4 w-4" />
                        </Button>
                      </Link>
                      <Link href={`/dashboard/automation/whatsapp-forms/${form._id}/edit`}>
