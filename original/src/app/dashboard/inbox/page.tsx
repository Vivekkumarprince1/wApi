...
export default function InboxPage() {
  ...
  const agents = agentsData?.data?.members || [];
  ...
  useEffect(() => {
    ...
    socket.on('inbox:status_update', handleStatusUpdate);
    ...
    socket.on('inbox:conversation_updated', handleConversationRefresh);
    socket.on('inbox:reopened', handleConversationRefresh);

    return () => {
      socket.off('inbox:message_new', handleNewMessage);
      socket.off('inbox:status_update', handleStatusUpdate);
      socket.off('inbox:message_status', handleStatusUpdate);
      socket.off('inbox:status_batch', handleStatusBatch);
      socket.off('inbox:conversation_updated', handleConversationRefresh);
      socket.off('inbox:reopened', handleConversationRefresh);
    };
