    ...
    () => [
      {
        ...
        items: [
          ...
          { title: "Inbox", url: "/dashboard/inbox", icon: Inbox, feature: "INBOX" },
          { title: "Billing", url: "/dashboard/billing", icon: CreditCard, feature: "BILLING" },
        ],
      },
      {
        label: "Messaging",
        items: [
          { title: "Campaigns", url: "/dashboard/campaign", icon: Megaphone, feature: "CAMPAIGNS" },
          { title: "Contacts", url: "/dashboard/contacts", icon: Users, feature: "CONTACTS" },
          { title: "Ads", url: "/dashboard/ads", icon: BarChart, feature: "ADS" },
        ],
      },
      {
        label: "Features",
        items: [
          {
            ...
            icon: Store,
            children: [
              { title: "Templates & Library", url: "/dashboard/templates", feature: "TEMPLATES_LIBRARY" },
              { title: "Campaigns", url: "/dashboard/campaign", feature: "CAMPAIGNS" },
            ],
          },
          {
            title: "Automation",
            ...
            icon: Zap,
            children: [
              { title: "Flow Hub", url: "/dashboard/automation", feature: "FLOW_HUB" },
              { title: "Workflows", url: "/dashboard/automation/workflows", feature: "WORKFLOWS" },
              { title: "Auto Replies", url: "/dashboard/automation/auto-replies", feature: "AUTO_REPLIES" },
              { title: "Instagram QuickFlows", url: "/dashboard/automation/instagram-quickflows", feature: "INSTAGRAM_QUICKFLOWS" },
              { title: "WhatsApp Forms", url: "/dashboard/automation/whatsapp-forms", feature: "WA_FORMS" },
              { title: "AnswerBot Training", url: "/dashboard/automation/answerbot", feature: "ANSWERBOT" },
              { title: "AI Intent Match", url: "/dashboard/automation/ai-intent-matching", feature: "AI_INTENT" },
              { title: "Interaktive List", url: "/dashboard/automation/interaktive-list", feature: "INTERAKTIVE_LIST" },
            ],
          },
          {
            title: "Sales CRM",
            ...
            icon: LayoutGrid,
            children: [
              { title: "Pipeline", url: "/dashboard/crm/pipeline", feature: "PIPELINE" },
              { title: "Tasks", url: "/dashboard/crm/tasks", feature: "TASKS" },
              { title: "Reports", url: "/dashboard/crm/reports", feature: "REPORTS" },
            ],
          },
          {
            title: "Commerce",
            ...
            icon: ShoppingBag,
            children: [
              { title: "Catalog", url: "/dashboard/commerce/catalog", feature: "CATALOG" },
              { title: "Order Panel", url: "/dashboard/commerce/orders", feature: "ORDERS" },
              { title: "Checkout Bot", url: "/dashboard/commerce/checkout-bot", feature: "CHECKOUT_BOT" },
              { title: "Settings", url: "/dashboard/commerce/settings", feature: "COMMERCE_SETTINGS" },
            ],
          },
        ],
      },
      {
        ...
        items: [
          { title: "Chat Analytics", url: "/dashboard/analytics/advanced", icon: BarChart3, feature: "ANALYTICS" },
          { title: "Chat Assignment", url: "/dashboard/support/chat-assignment", icon: Users, feature: "CHAT_ASSIGNMENT" },
          { title: "Team Management", url: "/dashboard/settings/teams", icon: UserPlus, feature: "TEAM_MGMT" },
          { title: "Macros", url: "/dashboard/support/macros", icon: Zap, feature: "MACROS" },
        ],
      },
      {
        label: "Tools",
        items: [
          { title: "Integrations", url: "/dashboard/integrations", icon: Puzzle, feature: "INTEGRATIONS" },
          { title: "Widget", url: "/dashboard/widget", icon: Grid, feature: "WIDGET_CONFIG" },
        ],
      },
    ],
    []
               ...
               <div className="hidden group-data-[collapsible=icon]:flex items-center justify-center pt-2">
                  <div 
                    ...
                    onClick={() => {
                      ...
                      setIsAdminMode(next);
                      router.push(next ? '/super-admin' : '/dashboard');
                    }}
                  />
               </div>
            )}
