 ...
 * @param {string|null} templateId - Template ID to monitor (optional for list mode)
 * @param {Object} options - Configuration options
 * @returns {Object} Template status and controls
 */
export function useTemplateStatus(templateId = null, options = {}) {
  const {
 ...
 */
export function useApprovedTemplates(options = {}) {
...
export function useTemplateSubmission() {
  ...
  const submit = useCallback(async (templateId) => {
    setSubmitting(true);
    setError(null);
    setResult(null);
