...
import { fetchTemplates, getTemplateCategories, deleteTemplate, syncTemplatesFromMeta, submitTemplateToMeta, createTemplate } from '../../../lib/api';
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Create and manage WhatsApp message templates</p>
          </div>
