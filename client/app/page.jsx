...
export default function HomePage() {
  ...
  const handleSignupOTPSuccess = (data) => {
  ...
  const handleLoginOTPSuccess = (data) => {
        ...
        <>
          ...
          {currentSection === 'home' && (
            ...
            >
              ...
              {/* Three Ways to Get Started Section - Updated Design */}
              <section
                ...
                <div className="max-w-7xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    >
                      ...
                      <p
                        className="mb-6 flex-1 text-base leading-relaxed transition-colors duration-300"
                        style={{ color: isDark ? '#cccccc' : '#666666' }}
                      >
                        Monthly or annual plans available. Choose what works best for your business needs.
                      </p>
                      <button
                        onClick={() => router.push('/auth/register')}
                    ...
                    >
                      ...
                      <p
                        ...
                        style={{ color: isDark ? '#cccccc' : '#666666' }}
                      >
                        Get started quickly with our streamlined onboarding process. We'll guide you every step.
                      </p>
                      <button
                        onClick={() => router.push('/auth/register')}
                        className="px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 text-white bg-gradient-to-r from-primary to-primary/80 shadow-premium hover:shadow-xl"
                    ...
                    >
                      ...
                      <p
                        ...
                        style={{ color: isDark ? '#cccccc' : '#666666' }}
                      >
                        Get personalized guidance from our WhatsApp Business specialists to maximize results.
                      </p>
                      <button
                        onClick={() => router.push('/auth/register')}
                        className="px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 text-white bg-gradient-to-r from-primary to-primary/80 shadow-premium hover:shadow-xl"
              ...
              {/* Feature Comparison / USP Section */}
