  ...
  return (
    <div className="">
          ...
          <div className="flex items-center justify-between">
            ...
            <button 
              ...
              className={`flex items-center space-x-2 px-5 py-2.5 rounded-xl font-semibold transition-all hover:scale-105 ${
                botEnabled ? 'bg-white text-primary' : 'bg-white/20 text-white border border-white/30'
              }`}
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-card rounded-2xl shadow-premium p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-muted-foreground text-sm">Checkouts Today</p>
          ...
          <div className="bg-card rounded-2xl shadow-premium p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-muted-foreground text-sm">Bot Interactions</p>
        ...
        <div className="bg-card rounded-2xl shadow-premium p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-foreground">Bot Features</h3>
          ...
          <div className="space-y-4">
            {features.map((feature, idx) => (
              <div key={idx} className="flex items-center justify-between p-4 bg-muted rounded-xl">
                ...
                <button className={`ml-4 p-2 rounded-xl ${
                  feature.enabled 
        ...
        {/* Bot Flow Preview */}
        <div className="bg-card rounded-2xl shadow-premium p-6">
          <h3 className="text-xl font-bold text-foreground mb-4">Checkout Flow Preview</h3>
