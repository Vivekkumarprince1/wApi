...
export default function EditAutoReplyPage() {
  ...
  const loadAutoReply = async () => {
    try {
      ...
      const response = await fetch(`/api/v1/auto-replies/${params.id}`, {
      ...
      if (response.ok) {
        ...
        setError('Failed to load auto-reply');
      }
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.message || 'Failed to update auto-reply');
      }
    } catch (err) {
      setError('Error: ' + err.message);
      console.error(err);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading auto-reply...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Auto-Reply</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Update auto-reply settings</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            >
              {loading ? 'Updating...' : 'Update Auto-Reply'}
            </button>
            <Link
              href="/automation/auto-replies"
