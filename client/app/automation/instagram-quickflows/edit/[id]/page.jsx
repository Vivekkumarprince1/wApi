...
export default function EditInstagramQuickflowPage() {
  ...
  const loadQuickflow = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError('Failed to load quickflow');
      }
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(err.message || 'Failed to update quickflow');
      }
    } catch (err) {
      setError('Error: ' + err.message);
      console.error(err);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading quickflow...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Instagram Quickflow</h1>
              <p className="text-gray-600 dark:text-gray-400 mt-1">Update your quickflow configuration</p>
            </div>
          </div>
        </div>
      </div>
