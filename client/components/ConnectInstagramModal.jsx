...
const ConnectInstagramModal = ({ isOpen, onClose }) => {
  if (!isOpen) return null;

  const handleGoToInstagram = () => {
    // Open Instagram OAuth or connection flow
    window.open('https://www.instagram.com/accounts/login/', '_blank');
    // You can replace this with your actual Instagram OAuth URL
  };
        ...
        <div className="px-8 pb-8">
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center space-x-4">
              ...
              {/* Instagram Icon */}
              <div className="w-20 h-20 bg-gradient-to-br from-purple-100 via-pink-100 to-orange-100 dark:from-purple-900/30 dark:via-pink-900/30 dark:to-orange-900/30 rounded-full flex items-center justify-center">
          ...
          {/* Description */}
          <div className="flex items-start space-x-3 mb-6 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
