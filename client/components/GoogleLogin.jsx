      ...
      <div className="w-full">
        <div className="w-full flex justify-center">
          <button
            ...
            className={`w-full rounded-xl border-2 border-gray-200 bg-white h-12 px-6 flex items-center justify-center gap-3 text-gray-500 transition-all shadow-sm ${scriptFailed ? 'hover:bg-muted cursor-pointer' : 'cursor-not-allowed opacity-60'}`}
          >
    ...
    <div className="w-full">
      <div id={`google-signin-button-${formType}`} className="w-full flex justify-center">
        <button
          ...
          className="w-full rounded-xl border-2 border-gray-200 bg-white hover:bg-muted hover:border-gray-300 h-12 px-6 flex items-center justify-center gap-3 text-gray-700 transition-all shadow-sm hover:shadow-md active:scale-[0.98]"
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24">
            <path fill="#EA4335" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
            <path fill="#4285F4" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
