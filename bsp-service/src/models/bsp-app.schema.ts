...
export type BspAppDocument = HydratedDocument<BspApp>;
...
export const BspAppSchema = SchemaFactory.createForClass(BspApp);
BspAppSchema.index({ workspaceId: 1, provider: 1, appId: 1 }, { unique: true });
BspAppSchema.index({ workspaceId: 1, gupshupAppId: 1 }, { sparse: true });
BspAppSchema.index({ workspaceId: 1, status: 1 });
