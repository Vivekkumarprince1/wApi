...
import { BspTemplateRule } from '../models/bsp-template-rule.schema';
...
export class TemplatesPublicController {
  constructor(
    @InjectModel(BspTemplateMirror.name) private readonly templateModel: Model<BspTemplateMirror>,
    @InjectModel(BspTemplateRule.name) private readonly ruleModel: Model<BspTemplateRule>,
