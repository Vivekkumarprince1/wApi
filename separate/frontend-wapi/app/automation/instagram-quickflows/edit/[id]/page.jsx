    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">Loading quickflow...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-card border-b border-border sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Edit Instagram Quickflow</h1>
              <p className="text-muted-foreground mt-1">Update your quickflow configuration</p>
            </div>
          </div>
        </div>
      </div>
