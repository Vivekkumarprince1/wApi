...
export default function GetStartedWays({ isDark }) {
  const router = useRouter();
  const appName = process.env.NEXT_PUBLIC_APP_NAME || 'WABA';
  ...
  const cards = [
    ...
    {
      title: `Setup in Minutes Save your time with ${appName}`,
      desc: "Get started quickly with our streamlined onboarding process. We'll guide you every step.",
      btn: 'Get Started →',
      svg: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
